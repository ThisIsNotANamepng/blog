...
1. The professor had a complete mastery of not only the subject, but also **how to teach** the subject
2. The students grasped concepts quickly
...
Our code (better technical writeup there) -> [github.com/ThisIsNotANamepng/diagonalize](https://github.com/ThisIsNotANamepng/diagonalize)