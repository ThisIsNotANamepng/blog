...
The concept of large scale disinformation efforts is widely recognized and studied in the world today. For example, [Russian interference in the 2016 US general election](https://www.intelligence.senate.gov/publications/committee-findings-2017-intelligence-community-assessment).

I classify this example as a targeted campaign because [research shows](https://www.nature.com/articles/s41467-022-35576-9) that the campaign largely only reached strongly Republican voters.
...
Further research is necessary into the efficacy of these types of efforts, as research into one of the best known examples (the 2016 US election) has [suggested](https://www.nature.com/articles/s41467-022-35576-9) that it has limited effectiveness.
...
While large scale influence efforts are not novel and are well documented, small scale efforts are no less feasible. For example, Israeli Intelligence agencies [influencing social media](https://www.nytimes.com/2024/06/05/technology/israel-campaign-gaza-social-media.html) to show messages urging key US lawmakers to sponsor military funding for Israel.

## Censorship

Censorship is another well documented class of Influence Warfare, as its use has reached [nearly every modern dictatorship](https://www.tandfonline.com/doi/full/10.1080/13510347.2020.1747051). It is an extremely effective way of controlling a populace. While traditional examples place censorship at controlling the influx of information from the internet to a nation's citizens by a government, note that disinformation may be used by any type of group to control the information reaching any target.
...
But of course, this doesn't end at social media. Internet users interact with technology [for 6 hours and 31 minutes a day on average](https://datareportal.com/global-digital-overview). Other devices or websites can be manipulated too. Search engines returning more depressing results, chat rooms and video games [matching up people who provoke each other into anger at each other or the world](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5587273/), VR headsets literally changing the user's point of view, email inboxes only showing malicious emails and removing any contact with real friends.
