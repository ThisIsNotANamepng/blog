...
But methods of communication have changed significantly since the days of strictly print journalism. [According the the Pew Research Center](https://www.pewresearch.org/journalism/fact-sheet/social-media-and-news-fact-sheet/), 50% of adults in the US get news from social media ('often' or 'regularly'). [It's already established how susceptible social media is to mis and dis information](https://www.apa.org/topics/journalism-facts/how-why-misinformation-spreads), and how its spread is often accelerated through social media algorithms. It's now easier than ever before for a few people or companies to absolutely control the flow of information.

This can be used to change opinion and momentum against the movements that would displace those few people or companies from power. [Hard right conservatives can push ads and talking points that push a certain narrative](https://news.yale.edu/2023/03/31/study-links-hard-right-social-media-incidents-civil-unrest). Companies can push that they're not damaging to the public. Politicians can pay groups to discourage or disrupt stories which cover a scandal.
